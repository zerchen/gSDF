...
cfg.task = 'hsdf_osdf_2net_video_pa'
...
cfg.testset_hand_source = 'dexycb/data/mesh_data/mesh_hand/'
cfg.testset_obj_source = 'dexycb/data/mesh_data/mesh_obj/'
cfg.num_testset_samples = 5928
...
def update_config(cfg, args, mode='train'):
    ...
    if mode == 'train':
        exp_info = [cfg.trainset_3d + cfg.trainset_3d_split, 'nf' + str(cfg.num_frames), cfg.backbone_pose.replace('_', ''), cfg.backbone_shape.replace('_', ''), 'h' + str(int(cfg.hand_branch)), 'o' + str(int(cfg.obj_branch)), 'sdf' + str(cfg.sdf_head.layers), 'cls' + str(int(cfg.hand_cls)), 'rot' + str(int(cfg.obj_rot)), 'hand_' + cfg.hand_encode_style + '_' + str(cfg.hand_point_latent), 'obj_' + cfg.obj_encode_style + '_' + str(cfg.obj_point_latent), 'np' + str(cfg.num_sample_points), 'adf' + str(int(cfg.with_add_feats)), 'fatrans' + str(int(cfg.fa_trans)), 'e' + str(cfg.end_epoch), 'ae' + str(cfg.sdf_add_epoch), 'scale' + str(cfg.recon_scale), 'b' + str(cfg.num_gpus * cfg.train_batch_size), 'hsw' + str(cfg.hand_sdf_weight), 'osw' + str(cfg.obj_sdf_weight), 'hcw' + str(cfg.hand_cls_weight), 'vw' + str(cfg.volume_weight)]
